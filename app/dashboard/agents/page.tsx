...
export default function DashboardAgentsPage() {
  ...
  return (
    <div className="p-8 animate-in fade-in duration-700">
      <div className="mb-8">
        <h1 className="font-serif-display text-4xl text-white mb-2">AI Agents</h1>
        <p className="text-neutral-400 text-sm">
          Activate and configure autonomous agents to run your account on autopilot.
        </p>
      </div>
              ...
              >
                {!agent.is_unlocked && (
                  <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px] z-10 flex flex-col items-center justify-center p-6 text-center">
                    ...
                    <h4 className="font-bold text-white mb-1">Plan Upgrade Required</h4>
                ...
                <div className="mt-auto pt-4 border-t border-white/10 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {agent.settings?.is_enabled ? "Active" : "Off"}
                    </span>
                    <Switch
        ...
        <DialogContent className="bg-[#0b0b0a] border-white/10 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-neutral-400">
              This agent requires your own API key to run. Your key is encrypted before being stored in our database. We cannot see your key.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setByokDialog(false)}>Cancel</Button>
