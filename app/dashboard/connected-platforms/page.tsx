                ...
                <div className="p-6 rounded-2xl border border-white/10 bg-[#0b0b0a] hover:border-white/20 transition-colors">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-white font-medium">Instagram & Facebook</h3>
                                <p className="text-xs text-muted-foreground">Automate Comments and DMs</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-6">
                        {loading ? (
                            ...
                            <div className="text-sm text-neutral-500">No Instagram or Facebook Pages connected.</div>
                        )}
                    </div>
                    <button 
