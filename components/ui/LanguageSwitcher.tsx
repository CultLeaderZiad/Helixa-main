...
export function LanguageSwitcher() {
  ...
  return (
    ...
    >
      <span className={language === "en" ? "text-neutral-400 font-medium" : "text-[#e5a93c] font-black text-lg drop-shadow-sm"}>ع</span>
      <span className="text-white/30 font-light">|</span>
      <span className={language === "en" ? "text-[#e5a93c] font-black text-lg drop-shadow-sm" : "text-neutral-400 font-medium"}>EN</span>
    </button>
  );
}
